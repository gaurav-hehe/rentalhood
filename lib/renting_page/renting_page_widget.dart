...
class RentingPageWidget extends StatefulWidget {
  const RentingPageWidget({Key key}) : super(key: key);
                                                      ...
                                                      StreamBuilder<
                                                        ...
                                                        builder: (context,
                                                          ...
                                                          List<TransactionsRecord>
                                                              productPriceTransactionsRecordList =
                                                              snapshot.data;
                                                          // Return an empty Container when the document does not exist.
                                                          if (snapshot
                                                              .data.isEmpty) {
                                                          ...
                                                          final productPriceTransactionsRecord =
                                                              productPriceTransactionsRecordList
                                                                      .isNotEmpty
                                                                  ? productPriceTransactionsRecordList
                                                                      .first
                                                                  : null;
                                                          return Text(
                                                            productPriceTransactionsRecord
                                                                .price,
                                                            style:
                                                                FlutterFlowTheme
                                                                    .subtitle1
